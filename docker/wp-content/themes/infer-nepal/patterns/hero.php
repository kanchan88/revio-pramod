...
<section class="hero">
  <div class="container">
    ...
    <div class="hero-search">
      ...
      <input placeholder="Try Tally vs Swastik, school ERP, hospital HMS…" />
      <button class="btn primary">Search</button>
    </div>
    <div class="hero-trending">
      <span>Popular:</span>
      <a href="#" class="chip">Tally Prime</a>
      <a href="#" class="chip">School ERP</a>
      <a href="#" class="chip">Hotel PMS</a>
      <a href="#" class="chip">HR &amp; Payroll</a>
      <a href="#" class="chip">Odoo for SMBs</a>
    </div>
  </div>
</section>
<!-- /wp:html -->
